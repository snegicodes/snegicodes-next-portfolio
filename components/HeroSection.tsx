      ...
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-10 py-16 sm:py-32 md:py-44 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-2 md:w-3/5">
          ...
          <p className="text-lg mt-4 mb-6 md:text-2xl">
            ...
            based in Greater Noida, India. I love crafting software that not
            only solves problems but also adds value, making every day more
          ...
          <a
            href="https://drive.google.com/file/d/1OX3F-5gI-fW9n1p_LR1MYFf34B3MKl0q/view"
            target="_blank"
            rel="noreferrer"
